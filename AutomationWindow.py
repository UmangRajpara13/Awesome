...
from AppsList import AllApps, AppBar
...
"                           font-family: Courier;")
    ...
    def LoadToolBarUi(self):
        ...
        openAction = QAction(QIcon("icons/open"), "Ctrl+N", self)
        openAction.setShortcut("Ctrl+N")
        openAction.setStatusTip("Open")
        openAction.triggered.connect(self.Open)

        settingsAction = QAction(QIcon("icons/settings"), "Ctrl+M", self)
        settingsAction.setShortcut("Ctrl+M")
        settingsAction.triggered.connect(self.Settings)

        infoAction = QAction(QIcon("icons/info"), "Alt+i", self)
        infoAction.setShortcut("Alt+X")
        infoAction.triggered.connect(self.Info)

        exitAct = QAction(QIcon('exit24.png'), 'Bye!', self)
